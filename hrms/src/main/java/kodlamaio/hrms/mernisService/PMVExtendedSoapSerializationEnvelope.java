...
public class PMVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PMVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PMVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PMVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PMVDateTimeConverter dateTimeConverter = new PMVStandardDateTimeConverter();

    public PMVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PMVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PMVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PMVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PMVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PMVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
