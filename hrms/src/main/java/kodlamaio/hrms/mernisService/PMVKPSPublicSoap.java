...
public class PMVKPSPublicSoap
{
    ...
    public PMVKPSPublicSoap(){}

    public PMVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PMVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PMVExtendedSoapSerializationEnvelope envelope= new PMVExtendedSoapSerializationEnvelope(PMVExtendedSoapSerializationEnvelope.VER11);
